        ...
        <div className="space-y-6">
            ...
            <Card>
                ...
                <CardDescription className="mb-4">
                    Cross-client health from the Jira vs Bitmap estimate delta
                    on active projects whose start and end dates include today.
                    A project is a risk when remaining Jira effort exceeds
                    remaining budget. Open a row for detail or weekly status.
                </CardDescription>
        ...
        <table className="w-full min-w-[720px] border-collapse text-left text-sm">
            <thead>
                <tr className="border-b border-border text-muted">
                    ...
                    <th className="px-2 py-2 font-medium">Estimate Δ</th>
            ...
            <tbody>
                {projects.map((project) => (
                    ...
                    >
                        ...
                        <td className="px-2 py-3 font-mono text-xs">
                            {formatWorkingDuration(project.estimateDeltaHours)}
                        </td>
                        <td className="px-2 py-3">
                            <Badge variant={riskBadge(project.riskTier)}>
                                {project.riskTier}
                            </Badge>
                            {project.riskReasons[0] ? (
